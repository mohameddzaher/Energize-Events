...
const Clients = () => {
  ...
  const clients = [
    ...
    { name: "Balad Dev Company", logo: "/images/clients/AlBalad Dev Company-.png" },
    ...
    // Second group
    { name: "Rixos Hotel", logo: "/images/clients/Rixos-.png" },
    { name: "PetroRabigh", logo: "/images/clients/Petro Rabigh-.png" },
    // Third group
    ...
    { name: "Prince Sultan Aviation Academy", logo: "/images/clients/Avaition Academy-.png" },
  ];
