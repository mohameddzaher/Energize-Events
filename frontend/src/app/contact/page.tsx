      ...
      <main>
        ...
        <section className="relative pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="https://www.independentarabia.com/sites/default/files/article/mainimage/2019/10/28/116391-1787028584.jpg"
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
            <div className="max-w-4xl mx-auto">
              ...
              <motion.a
                ...
                className="relative h-64 sm:h-80 md:h-96 rounded-xl overflow-hidden shadow-xl border border-gray-200 mb-4 group cursor-pointer block"
              >
